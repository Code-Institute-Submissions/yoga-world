# Yoga World
View the project live [here](https://colin-k88.github.io/yoga-world/)
## Overview
...
## Wireframes
* [Desktop](https://github.com/Colin-K88/yoga-world/blob/master/assets/wireframes/desktop/Desktop1.png)
* [Ipad](https://github.com/Colin-K88/yoga-world/blob/master/assets/wireframes/ipad/ipad1.png)
* [Mobile](https://github.com/Colin-K88/yoga-world/blob/master/assets/wireframes/mobile/mobile1.png)
## UX
### Strategy
...
* Home Page: Mobile
![Alt text](assets/Testing-Images/IndexMobileL.png)

* Schedule Page: Desktop
![Alt text](assets/Testing-Images/ScheduleDesktopL.png)
* Schedule Page: Mobile
![Alt text](assets/Testing-Images/ScheduleMobileL.png)

* Team Page: Desktop
![Alt text](assets/Testing-Images/TeamDesktopL.png)
* Teamm Page: Mobile
![Alt text](assets/Testing-Images/TeamMobileL.png)

* Contact Page: Desktop
![Alt text](assets/Testing-Images/ContactDesktopL.png)
* Contact Page: Mobile
![Alt text](assets/Testing-Images/ContactMobileL.png)

### Validation Testing 
#### HTML / [W3C](https://validator.w3.org/)
* Home Page: Button tag was removed instead using just href link and styled in css.
![Alt text](assets/Testing-Images/index.png)
![Alt text](assets/Testing-Images/index1.png)

* Schedule Page: fixed-top was removed from nav element.
![Alt text](assets/Testing-Images/schedule.png)
![Alt text](assets/Testing-Images/schedule1.png)

* Team Page: New image was added with appropriate name not leaving spaces like previous.
![Alt text](assets/Testing-Images/ourteam.png)
![Alt text](assets/Testing-Images/ourteam1.png)

* Contact Page: Matched the "for" attribute in label with the with "id" attribute in textarea.
![Alt text](assets/Testing-Images/contact.png)
![Alt text](assets/Testing-Images/contact1.png)
...
" As a new user, I would like a way to contact the studio should I have a query."
> * The site provides a dedicated contact page for the user. They will have a link to the page in the navbar and in 
the footer across all pages. They will also have a link to the page on the hero image in the home page.

" As a new user, I would like to see the studio address clearly stated.."
> * This is done by putting the site address under the site name in the nav and footer so the user does not have to go and look 
for this information its already clearly stated at the top and bottom of the page.
...
"As a returning user, I would like to know the schedule will be updated if there is any changes."
> * A brief note is made under the timetable heading in the schedule page, it informs the user if there is any changes made it will be made first on the site not 
cause any inconvenience.

"As a returning user, I would like a direct link to access social media links fast and easy."
> * Links are provided in the footer across all oages in the form of an icon should a returning user want to show a 
friend they wil have clear and direct access to do so.
